...
#include "stdafx.h"
#include "ShenoyMaterial.h"

BEGIN_PARAMETER_LIST(FEShenoyMaterial, FEElasticMaterial)
	...
	ADD_PARAMETER2(m_Ef, FE_PARAM_DOUBLE, FE_RANGE_GREATER_OR_EQUAL(0.0), "Ef");
	ADD_PARAMETER2(m_lamc, FE_PARAM_DOUBLE, FE_RANGE_GREATER_OR_EQUAL(1.0), "lam_c");
	ADD_PARAMETER2(m_lamt, FE_PARAM_DOUBLE, FE_RANGE_NOT_EQUAL(0.0), "lam_t");
	ADD_PARAMETER2(m_n   , FE_PARAM_DOUBLE, FE_RANGE_GREATER_OR_EQUAL(1.0), "n");
	ADD_PARAMETER2(m_m   , FE_PARAM_DOUBLE, FE_RANGE_GREATER_OR_EQUAL(1.0), "m");
END_PARAMETER_LIST();
